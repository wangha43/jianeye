...
$result = oil_init("分公司", $id, $page);
$limit = 10;
$count = $result["count"];
$son = get_soncompany("分公司", $id, $page);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>分公司油耗趋势表</title>
</head>
    <?php echo $linkheader;?>
    <style type="text/css">
    </style>
            ...
            <div class="row">
                 <div class="col-sm-6">
                    <div id="container_3"></div>
                          <?php echo page($page, $count, $limit, 4);?>[0]
                </div>
            </div>
            <div class="row">
             <div class="col-sm-6" >
 ...
 -->                    <br>
        ...
        <?php foreach ($son as $item) {?>
                        <tr>
                            ...
                            <td><a href="oil_son_company.php?id=<?php echo $item['id'];?>">详情</a></td>
                        </tr>
        <?php }
?>
                    </table>
