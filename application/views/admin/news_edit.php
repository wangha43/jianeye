...
<body>
<div class="container">
    <h3 class="marginbot">修改文章<a href="<?php echo site_url('admin/news_list')?>" class="sgbtn">返回文章列表</a></h3>
    <div class="mainbox">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php foreach($col as $item){?>
                                <option value="<?php echo $item->id; ?>" <?php if($item->id==$detail[0]->cid){echo " selected";} ?>><?php echo $item->colum;?></option>
                            <?php }?>
                        </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                        <input name="title" class="txt" style="width:400px;" type="text" value="<?php echo $detail[0]->title;?>">
                        </td>
                    </tr>
                    <tr>
                        <th>文章内容：</th>
                    ...
                    <tr>
                        <td>
         <input type="text" readonly="readonly" name="time" id="addtime" value="<?php echo date('Y-m-d H:i',$detail[0]->time);?>"/>
...
<script name="content">
   var a= {
      ...
      var ue = UE.getEditor('editor',a);
        ...
        ue.ready(function() {
            //设置编辑器的内容
            ue.setContent('<?php echo $detail[0]->content;?>');
        });
