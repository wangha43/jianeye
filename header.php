...
$nav = <<<EOF
<div class="sidebar-menu toggle-others fixed"><!-- set fixed position by adding class "navbar-fixed-top" -->
		<div class="sidebar-menu-inner">
			...
			<ul  class="main-menu">
				...
				<li class="">
					<a><span class="title">主动安全管理</span></a>
					<ul>
					<li class="">
						<a>
				...
				<li>
					<a><apan>企业运营管理</apan></a>
				</li>
				<li>
					<a><apan>UBI保险</apan></a>
				</li>
				<li>
					<a><apan>车货配件平台</apan></a>
				</li>
				<li>
					<a><apan>车辆技术监控</apan></a>
				</li>
				<li>
					<a><apan>客户服务</apan></a>
				</li>
