...
$id = getstageid("线路", $typename)["id"];
$result = stage_history("线路", $id, $page);
$count = $result["count"];
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="page-container">
        <div class="main-content">
         <div class="row">
                ...
                <form action="">
                    <div class="col-sm-2" >
                        <input type="text" placeholder="请输入线路名称" class="form-control"  name="typename"></div>
                </div>
         <div class="row">
                    <div class="col-sm-5"></div>
                    <div class="col-sm-2">
                ...
                point: {
                    events: {
                        click: function() {
                            ...
                            $.post('http://localhost/jianeye/api/stage_history.php', { 'stage':'线路','date':this.category,'id':id}, function (text) {
                                            var json=eval(text);
                                            var dn =new Array();
