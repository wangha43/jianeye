...
<body>
    ...
    <div class="page-container">
       ...
       <?php echo $navr;?>
            ...
            <div class="row"  id="container_1" style="display:none">
                          <iframe src="" id="ch1" frameborder="0" name="ch1" width="100%" scrolling="no" height="0px"  onload="adjustIframeHeightOnLoad('ch1')">
                          </iframe>
            </div>
        ...
        plotOptions: {
            column: {
                ...
                point: {
                    events: {
                        click: function() {
                             window.open('../group/ch1.php?date='+this.category,'ch1');
