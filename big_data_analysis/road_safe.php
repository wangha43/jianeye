            ...
            <div class="row">
                  <div class="col-sm-12">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane " id="home-3"></div>
                        <div class="tab-pane" id="profile-3">  </div>
                        ...
                        <div class="tab-pane active" id="settings-3">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="trend.php?road=<?php echo urlencode($item["路段名"]);?>">查看整改效果</a>
                                </td>
                                <td>
                                    <a href="map.php?road=<?php echo urlencode($item["路段名"]);?>">地图模式</a>
                                </td>
                            </tr>
                            <?php }
?>
                    ...
                    <div class="row">
                        ...
                        <div class="tab-pane" id="inbox-3"></div>
                    </div>
  </div>
            </div>
        </div>
